...
(function (global) {
  ...
  const DICT = {
    ko: {
      ...
      dealer_name: '김종찬 팀장',
      telegram_channel_promo_1: '가장 빠른 매물 정보 !',
      telegram_channel_promo_2: '프롬케이카 텔레그램 채널',
    ...
    ru: {
      ...
      telegram_channel_promo_1: 'Самые быстрые новости об автомобилях!',
      telegram_channel_promo_2: 'Телеграм-канал FROM K CAR',
    ...
    mn: {
      ...
      dealer_name: 'KIM JONG CHAN',
      telegram_channel_promo_1: 'Хамгийн шуурхай мэдээлэл!',
      telegram_channel_promo_2: 'FROM K CAR-ийн Телеграм суваг',
    ...
    en: {
      ...
      dealer_name: 'KIM JONG CHAN',
      telegram_channel_promo_1: 'Fastest listing updates!',
      telegram_channel_promo_2: 'FROM K CAR Telegram channel',
