...
(function (global) {
  ...
  const DICT = {
    ko: {
      ...
      dealer_name: '김종찬 팀장',
      telegram_channel_promo: '가장 빠른 매물정보! 프롬케이카 텔레그램 채널',
    ...
    ru: {
      ...
      telegram_channel_promo: 'Самые быстрые новости об автомобилях! Телеграм-канал FROM K CAR',
    ...
    mn: {
      ...
      dealer_name: 'KIM JONG CHAN',
      telegram_channel_promo: 'Хамгийн шуурхай мэдээлэл! FROM K CAR-ийн Телеграм суваг',
    ...
    en: {
      ...
      dealer_name: 'KIM JONG CHAN',
      telegram_channel_promo: 'Fastest listing updates! FROM K CAR Telegram channel',
